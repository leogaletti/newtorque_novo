...
if($_POST){
	$id_query = mysql_query("INSERT INTO servicos(ds_servico,tit_servico) VALUES('{$_POST[ds_servico]}','{$_POST[tit_servico]}')") or die(mysql_error());
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<form action="cadastro_servico.php" method="post" enctype="multipart/form-data" name="cad_servico" id="" ONSUBMIT="javascript:return valida(this)">
    <tr>
	...
	<td><input name="tit_servico" type="text" size="51" maxlength="100"></td>
	</tr>
	<tr>
	...
	<td colspan="2">
<? 
$editor = new FCKeditor("ds_servico"); //Nomeia a &aacute;rea de texto
