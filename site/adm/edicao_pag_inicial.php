...
if($_POST){
 	$id_query = mysql_query("UPDATE paginas SET ds_pag_inicial = '{$_POST['ds_pag_inicial']}'") or die(mysql_error());
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<form action="edicao_pag_inicial.php" method="post" enctype="multipart/form-data">
	<tr>
    ...
    <tr>
    <td align="left" class="style2">Edi&ccedil;&atilde;o do texto da  P&aacute;gina Inicial </td>
	</tr>
	<tr>
    <td align="center">
<? 
$editor = new FCKeditor("ds_pag_inicial"); //Nomeia a área de texto
$editor-> BasePath = "../fckeditor/";  //Informa a pasta do FKC Editor
$editor-> Value = $arr['ds_pag_inicial'];             //Informa o valor inicial do campo, no exemplo está vazio 
