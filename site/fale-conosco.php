...
<div class="newt-nav-inner">
	...
	<ul class="newt-hmenu">
		...
		<li>
			<a href="./fale-conosco.php" class="active">Fale Conosco</a>
		</li>	
	</ul>
	</div>
</div>
...
<div class="newt-content-layout layout-item-1">
    ...
    <div class="newt-layout-cell layout-item-2" style="width: 75%; background-attachment: scroll; background-image: url(imagens/fundo_conteudo.gif); background-repeat: no-repeat;  background-position: top; height:600px; ">
        <p><span style="color: rgb(201, 29, 32); font-size: 24px; font-weight: bold; line-height: 24px; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px;">Fale Conosco</span></p>
<p>
<?
	$id_query = mysql_query("SELECT * FROM paginas");
	$arr1 = mysql_fetch_assoc($id_query);
	echo($arr1[ds_pag_faleconosco]);
?>
</p>
<p>
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" >
                    <form action="resp_contato.php" method="post" name="contato" enctype="multipart/form-data" ONSUBMIT="javascript:return valida(this)">
                      <tr align="center">
                        <td colspan="3">&nbsp;</td>
                      </tr>
                      <tr height="20">
				    ...
				    <tr>
				      <td height="10" align="right">Assunto:</td>
                        <td>&nbsp;</td>
	      				<td height="10"><select name="area" id="select_form_opcao">
	        ...
	        <option value="Diretoria">Diretoria</option>
                      ...
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><input name="empresa" type="text" size="39" ></td>
                      </tr>
					  <tr>
        				<td align="right"> (DDD) Telefone:</td>
                        <td>&nbsp;</td>
        				<td><input name="ddd" type="text" class="campo-texto" size="3" style="background:transparent;" />
          				<input name="telefone" type="text" class="campo-texto" size="12" style="background:transparent;" />
         				</td>
				      </tr>
                      <tr>
          ...
          <select name="estado" size="1" >
            ...
            <option value="TO">TO</option>
                      ...
                      <tr>
                        <td align="right">Sua Mensagem:</td>
                        <td>&nbsp;</td>
                        <td>
