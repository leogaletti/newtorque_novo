...
<div class="newt-nav-inner">
	...
	<ul class="newt-hmenu">
		...
		<li>
			<a href="./linha-equipamentos.php" class="active">Linha Equipamentos</a>
		</li>	
		<li>
...
?>
       	<li>
		<div id="menus">
		<a href="#" onclick="submenu('sub<? echo($contador) ?>');"><? echo($arr_linha[tit_linha]) ?></a>
		<ul id="sub<? echo($contador) ?>" style="display:none;">
<?
