...
<div class="newt-nav-inner">
	...
	<ul class="newt-hmenu">
		...
		<li>
			<a href="./localizacao.php" class="active">Localiza&ccedil;&atilde;o</a>
		</li>	
		<li>
...
<div class="newt-content-layout layout-item-1">
    ...
    <div class="newt-layout-cell layout-item-2" style="width: 75%; background-attachment: scroll; background-image: url(imagens/fundo_conteudo.gif); background-repeat: no-repeat;  background-position: top; height:600px; ">
        <p><span style="color: rgb(201, 29, 32); font-size: 24px; font-weight: bold; line-height: 24px; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px;">Localiza&ccedil;&atilde;o</span></p>
        
<p>
<?
	$id_query = mysql_query("SELECT * FROM paginas");
	$arr1 = mysql_fetch_assoc($id_query);
	echo($arr1[ds_pag_localizacao]);
?>
</p>
<p>
        <table width="100%" border="0">
            <tbody>
                <tr align="center">
                    <td>
                        <iframe width="640" height="640" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.br/maps?f=q&amp;source=s_q&amp;hl=pt-BR&amp;geocode=&amp;q=new+torque&amp;sll=-14.239424,-53.186502&amp;sspn=47.712927,56.513672&amp;t=h&amp;ie=UTF8&amp;hq=new+torque&amp;hnear=&amp;cid=15318425418330821821&amp;ll=-19.539084,-42.648325&amp;spn=0.038826,0.054932&amp;z=14&amp;iwloc=A&amp;output=embed" frameborder="1"></iframe><br />
        
                        <h6><a href="http://maps.google.com.br/maps?f=q&amp;source=embed&amp;hl=pt-BR&amp;geocode=&amp;q=new+torque&amp;sll=-14.239424,-53.186502&amp;sspn=47.712927,56.513672&amp;t=h&amp;ie=UTF8&amp;hq=new+torque&amp;hnear=&amp;cid=15318425418330821821&amp;ll=-19.539084,-42.648325&amp;spn=0.038826,0.054932&amp;z=14&amp;iwloc=A" style="color:#0000FF; text-align:center" target="_new">Exibir mapa ampliado</a></h6>
                    </td>
                </tr>
            </tbody>
        </table>
