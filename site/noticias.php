...
<div class="newt-content-layout">
    <div class="newt-content-layout-row">
    <div class="newt-layout-cell layout-item-0" style="width: 75%; vertical-align:top;  background-attachment: scroll; background-image: url(imagens/fundo_conteudo.gif); background-repeat: no-repeat;  background-position: top; height:600px;" >
...
?>
            <li>                  
<?
			$novadata = substr($arr[ds_data],8,2) ."/". substr($arr[ds_data],5,2); 
?>
        	<a href="noticia_completa.php?cd=<? echo($arr[cd_noticia]) ?>"><? echo($novadata." - ".$arr[tit_noticia]) ?></a>
            </li>
<?
	}
?>
