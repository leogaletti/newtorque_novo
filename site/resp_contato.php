...
if ($securimage->check($captcha_code) == false) {
  ...
  echo "O Código está incorreto, digite novamente.<br /><br />";
...
<p align=\"center\"><font size=\"3\" face=\"Verdana,Arial\">Contato de Visitantes do Site</font></p>
...
<br><br>
<br><br><b>Destino da Mensagem: </b>"." $area
<br><br><b>Nome: </b>"." $nome
<br><br><b>Empresa: </b>"." $empresa 
...
BUSKAQUI - Uma busca, vários negócios !<br>
...
$headers .= "From: Formulário do site <form@newtorque.com.br>\n";
$headers .= "Reply-to: ".$email."\r\n";
$headers .= "Bcc: <portalnec@gmail.com>\n";

$formsent = mail($to, $subject, $message, $headers);
if($formsent ==1){
	print("<b>$nome</b>, Sua mensagem foi enviada com sucesso!");
}else{
