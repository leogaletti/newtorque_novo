...
<div class="newt-nav-inner">
	...
	<ul class="newt-hmenu">
		...
		<li>
			<a href="./servicos.php" class="active">Servi&ccedil;os</a>
		</li>	
		<li>
...
<div class="newt-content-layout layout-item-1">
   ...
   <div class="newt-layout-cell layout-item-2" style="width: 75%; background-attachment: scroll; background-image: url(imagens/fundo_conteudo.gif); background-repeat: no-repeat;  background-position: top; height:600px; ">
        <p><span style="color: rgb(201, 29, 32); font-size: 24px; font-weight: bold; line-height: 24px; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px;">Servi&ccedil;os</span></p>
...
?>
        ...
        <p> <span class="newt-button-wrapper"><span class="newt-button-l"> </span><span class="newt-button-r"> </span><a href="servicos-executados.php" class="newt-button newt-button">Veja alguns servi&ccedil;os executados pela New Torque</a></span> <span style="color: rgb(64, 64, 64);"><br /></span></p>
