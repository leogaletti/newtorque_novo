...
function valida(theForm){
	if (isBlank(theForm.nome)) {
	    ...
	    alert("Digite um numero de CPF válido!");
		document.contato.cpf.focus(); 
	    return false;
          ...
          <select name="estado" size="1" >
            ...
            <option value="TO">TO</option>
                      ...
                      <tr>
						...
						<tr>
      					<td colspan="3" align="center">Envie mais informações para <a href="mailto:contato@newtorque.com.br">contato@newtorque.com.br</a></td>
					<tr>
