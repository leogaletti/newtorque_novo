...
<div class="newt-nav-inner">
	...
	<ul class="newt-hmenu">
		...
		<li>
			<a href="./videos.php" class="active">V&iacute;deos</a>
		</li>	
		<li>
...
<div class="newt-post-inner newt-article">
                                <h2 class="newt-postheader">V&iacute;deos
                                </h2>
...
<?
	...
	echo($arr1[ds_pag_videos]);
?>
</p>

<?
				$id_query = mysql_query("SELECT * FROM videos where bl_publicar='1' ORDER BY cd_ordem");
...
?>
                	<div class="video">
                	<div class="tv">
                	<embed src="<? echo($arr[ds_link]) ?>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="300" height="243"></embed>
                	</div>
                	<h2><? echo($arr[ds_titulo]) ?></h2>
<?
					if(!empty($arr[ds_data])){
?>
						<span class="vermelho">Data:</span> <? echo($novadata) ?><br />
<?
					}
					if(!empty($arr[ds_local])){
?>
						<span class="vermelho">Local:</span> <? echo($arr[ds_local]) ?><br /><br />
<?
					}
?>
					<? echo($arr[ds_info]) ?><br /><br />
                	</div>
                	<hr>
<?
				}
